...
<h3 id="手动销毁"># 手动销毁</h3>
<span className="plain-text-md">show函数返回一个close函数，调用该函数可销毁Message</span>
<br />
<span className="plain-text-md">也可以使用notify，notify中使用了show函数，并增加了关闭按钮</span>
<br />
...
<tbody><tr><td>show</td>
<td>显示Message，参数见下文，返回一个close函数，可用于销毁Message</td></tr>
<tr><td>notify</td>
<td>使用了show，并添加了关闭按钮，传入duration参数无效，notify使用show函数时传入的duration为0</td></tr>
<tr><td>config</td>
<td>用于设置Message展示的默认时间，参数duration</td></tr></tbody>
</table>
...
<td>是</td></tr>
<tr><td>duration</td>
<td>消息展示的时间，单位ms，不传使用默认时间，传一个小于等于0的数或NaN不自动销毁</td>
<td>string | number</td>
<td>2000</td>
<td>否</td></tr>
<tr><td>key</td>
...
<td>消息内容的padding</td></tr></tbody>
</table>
<h3 id="特别说明"># 特别说明</h3>
<span className="plain-text-md">Message的每种位置有一个容器，容器是fixed定位，z-index值为9999</span>
<div className="right-nav-contain"><a className="right-nav" href="#基本使用">基本使用</a>
<a className="right-nav" href="#避免相同内容的message弹出多次">避免相同内容的message弹出多次</a>
<a className="right-nav" href="#设置显示时间">设置显示时间</a>
<a className="right-nav" href="#手动销毁">手动销毁</a>
<a className="right-nav" href="#位置">位置</a>
<a className="right-nav" href="#Message函数">Message函数</a>
<a className="right-nav" href="#show函数的参数">show函数的参数</a>
